...
-- -- Администраторы
-- ('Иванов Сергей Петрович', 'admin1', 'a1', 'admin', 1),
-- ('Смирнова Анна Владимировна', 'admin2', 'a2', 'admin', 2),

--  -- Врачи
-- ('Петров Дмитрий Игоревич', 'vet1', 'v1', 'doctor', 1),
-- ('Козлова Елена Александровна', 'vet2', 'v2', 'doctor', 1),
-- ('Сидоров Алексей Николаевич', 'vet3', 'v3', 'doctor', 2),
...
-- -- Менеджеры
-- ('Волкова Ольга Дмитриевна', 'manager1', 'm1', 'manager', 1),
-- ('Григорьев Павел Андреевич', 'manager2', 'm2', 'manager', 4);
